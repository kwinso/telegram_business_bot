...
module.exports.AskHandler = class AskHandler {
    bot;
    questions = [
        "Имя лица (Только буквы, не чуствительно к регистру)",
        "Фамилия лица (Только буквы, не чуствительно к регистру)",
        "Отчество лица (Только буквы, не чуствительно к регистру)",
